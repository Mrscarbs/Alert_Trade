...
func cashflow_master_generator(c *gin.Context) {
	...
	url := fmt.Sprintf("https://insbaapis.cmots.com/api/QuarterlyResults/%s/S/", co_code)
	fmt.Println(url)
...
func get_pnl(c *gin.Context) {
	...
	url := fmt.Sprintf("https://insbaapis.cmots.com/api/ProftandLoss/%s/S/", co_code)
	fmt.Println(url)
	req, err := http.NewRequest("GET", url, nil)
	if err != nil {
		log.Println(err)
...
func get_balance_sheet(c *gin.Context) {
	...
	url := fmt.Sprintf("https://insbaapis.cmots.com/api/Balancesheet/%s/S/", co_code)
	fmt.Println(url)
	req, err := http.NewRequest("GET", url, nil)
	if err != nil {
		log.Println(err)
...
func get_share_holding_pattern(c *gin.Context) {
	...
	url := fmt.Sprintf("https://insbaapis.cmots.com/api/ShareholdingMorethanonePerDetails/%s", co_code)
	fmt.Println(url)
	req, err := http.NewRequest("GET", url, nil)
	if err != nil {
		log.Println(err)
